namespace Common.Application
{
    ...
    {
        public const string SuccessMessage = "operation done successfully";
    ...
    {
        public const string SuccessMessage = "opertaion successfully completed";
        public const string ErrorMessage = "operation failed";
        public const string NotFoundMessage = "Missing entity";
        public string Message { get; set; }
        public string Title { get; set; } = null;
        public OperationResultStatus Status { get; set; }
